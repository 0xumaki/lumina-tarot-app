...
export const BADGES: Badge[] = [
  ...
  { id: "seven-seeker",    name: "Seven Seeker",   svg: "/badges/seven-seeker.svg",    desc: "Reach a 7-day streak",              tier: "free",    color: "#F09A3D", unlock: (c) => c.streak >= 1 },
  ...
  { id: "ritual-master",   name: "Ritual Master",  svg: "/badges/ritual-master.svg",   desc: "7-day ritual streak",               tier: "premium", color: "#D4B27A", unlock: (c) => c.isPremium && c.streak >= 1 },
